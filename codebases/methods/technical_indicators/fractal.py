# reference: https://github.com/mementum/backtrader/blob/master/backtrader/studies/contrib/fractal.py
...
class Fractal(bt.ind.PeriodN):
    '''References: [Ref 1] http://www.investopedia.com/articles/trading/06/fractals.asp'''
