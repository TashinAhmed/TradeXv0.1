...
if __name__ == "__main__":
    ...
    API_KEY=''
    Secret_Key=''
    stock_array= ['ETHUSD'] # Example: ['AAPL', 'NVDA', 'AMZN',  'TSLA', 'NVAX', 'MRNA', 'FB',  'DKS', 'AAL', 'W', 'CHWY', 'PLAY', 'SAVE', 'CAKE', 'ANF', 'SHAK', 'AAPN', 'DKS', 'BIG', 'GOOGL', 'CCL', 'FSLY', 'WKHS', 'OSTK', 'TUP', 'ZM', 'FTCH', 'BJ', 'FSLR']
