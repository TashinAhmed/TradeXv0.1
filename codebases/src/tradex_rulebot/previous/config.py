...
STOCK_MAX_PRICE = 100 # max price of symbol to buy
STOCK_MIN_PRICE = 20 # min price of symbol to buy
MAX_NUM_STOCKS = 20 # max number of different symbols to buy
NUM_SHARES = 5 # number of shares to buy of each symbol
SELL_PERCENT_GAIN = 3 # what percent gain triggers to sell during the day
START_EQUITY = 100000000 # how much money to start trading with
MOVED_DAYS = 5 # number of days for determing stock movement
MOVED_DAYS_CALC = 0 # use start/end prices (set to 0) of MOVED_DAYS or daily average (set to 1) of MOVED_DAYS
