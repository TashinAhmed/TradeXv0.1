...
def supertrend_bot(bar):
    try:
        ...
        print(f"Position: {position} | Should Sell: {should_sell}")
        ...
        if position == 0 and should_buy == True:
            ...
            print(message)
            position = check_positions(1, "buy")
            print(f"POSITION BUY TAG: {position}")
            # send_mail(message)
        ...
        # Check if Long Position and Sell Signal is True
            ...
            print(message)
            position = check_positions(1, "sell")
            print(f"POSITION SELL TAG: {position}")
            # send_mail(message)
        print("-"*20)
...
def send_mail(message_text):
    ...
    sender_email = 'tashinahmed.arisaftech@gmail.com'
    sender_password = 'HHHH'
    receiver_email = 'tashin@arisaftech.co.jp'
