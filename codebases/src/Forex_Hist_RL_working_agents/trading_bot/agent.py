...
def huber_loss(y_true, y_pred, clip_delta=1.0):
    '''
    huber loss for prediction. link wikipedia: https://en.wikipedia.org/wiki/Huber_loss
    '''
    error = y_true - y_pred
...
class Agent:
    ...
    def __init__(self, state_size, strategy="t-dqn", reset_every=1000, pretrained=False, model_name=None):
        ...
        self.model_name = model_name        # model utilized
        self.inventory = []
    ...
    def _model(self):
        """
        Creates a handbuilt simple model
        """
        model = Sequential()
