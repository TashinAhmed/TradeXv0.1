...
def train_agent(env, agent, visualize=False, train_episodes = 50, training_batch_size=500):
    ...
    # to track best average net worth
    best_average = 0 
...
if __name__ == "__main__":            
    ...
    test_agent(test_env, agent, visualize=True, test_episodes=10, folder="2021_11_18_22_18_Crypto_trader", name="1933.71_Crypto_trader", comment="")
