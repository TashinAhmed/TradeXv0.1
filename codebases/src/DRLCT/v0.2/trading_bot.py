#================================================================
#
#   File name   : trading_bot.py
#   Author      : Tashin Ahmed
#   Designation : Junior Data Engineer
#   E-mail      : tashinahmed.arisaftech@gmail.com (tashinahmed@aol.com)
#   Created date: 2021-12-13
#   Website     : https://tashinahmed.github.io/
#   GitHub      : 
#   Description : 
#
#================================================================
...
class CustomAgent:
    def __init__(
        ...
        # state size containing market + orders history for the last lookback_window_size steps
    ...
    # saving params info after training from train start time to end time  
    ...
    def get_gaes(
        ...
        deltas = [r + gamma * (1 - d) * nv - v for r, d, nv, v in zip(
            rewards, 
            dones, 
            next_values, 
            values
